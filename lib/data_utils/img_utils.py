...
def get_single_image_crop(image, bbox, scale=1.3, flag=None):
    ...
    if len(crop_image.shape) == 3:
        crop_image_tensor = convert_cvimg_to_tensor(crop_image)
        return crop_image, crop_image_tensor
    elif len(crop_image.shape) == 2:
        return crop_image
